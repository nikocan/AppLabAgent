...
- `DatabaseSchema` sayesinde platform durumunu sözlük olarak dışa aktarma ve tekrar
  yükleme.
- Frontend menülerini `navigation_menu` ile üretip eksik bölümleri hızla tespit etme.
...
menu_status = platform.navigation_menu()
...
entegrasyonları hızlıca yakalamanıza yardımcı olur. `navigation_menu` sonucu ise frontend
arayüzlerinde gösterilecek menü bölümlerini ve boş kalan alanları bildirerek eksik
verilerin kolayca tamamlanmasını sağlar.
